...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        svarEdtTxt = (EditText) findViewById(R.id.svarEditText);
        ogEdtTxt = (EditText) findViewById(R.id.ovreEditTxt);
